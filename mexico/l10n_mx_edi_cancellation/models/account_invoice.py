...
class AccountInvoice(models.Model):
    ...
    def l10n_mx_edi_request_cancellation(self):
        ...
        self.filtered(lambda inv: inv.l10n_mx_edi_sat_status != 'cancelled'
                      )._l10n_mx_edi_cancel()
    ...
    def l10n_mx_edi_cancellation(self):
        ...
        if self.mapped('company_id').l10n_mx_edi_pac_test_env:
            cancelled = self
    ...
    def action_invoice_draft(self):
        ...
        to_draft = inv_mx.filtered(
            lambda inv: not inv.move_id or not inv.move_id.reverse_entry_id)
    ...
    def action_invoice_cancel(self):
        ...
        in_period = invoices.filtered(
            lambda inv: inv.date_invoice >= date_utils.start_of(
