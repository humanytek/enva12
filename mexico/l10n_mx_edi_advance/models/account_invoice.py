...
class AccountInvoice(models.Model):
    ...
    def _compute_amount_advances(self):
        for record in self.filtered(
                lambda i: i.type == 'out_invoice' and i.l10n_mx_edi_origin and
    ...
    def _prepare_refund(self, invoice, date_invoice=None, date=None,
        ...
        adv_amount, partial_amount, lines, reverse_lines, partial_line = invoice._l10_mx_edi_prepare_advance_refund_fields()  # noqa
        ...
        values['l10n_mx_edi_origin'] = '%s|%s' % (
            '07', invoice.l10n_mx_edi_cfdi_uuid)
        adv_prod = self.company_id.l10n_mx_edi_product_advance_id
        ...
        line_values.update({
            ...
            'account_id': adv_prod.property_account_expense_id.id,
        })
