...
class stock_picking(models.Model):
    ...
    fecha_tipo_cambio = fields.Date(string='Fecha Tipo Cambio')
    fecha_tipo_cambio_requerida=fields.Boolean(string="Requiere la fecha del tipo de cambio",compute=_compute_fecha_tipo_cambio_requerida)
