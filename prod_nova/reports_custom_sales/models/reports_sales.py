            ...
            for invoice in invoices:
                ...
                lines.append({
                        ...
                        'columns':[
                            ...
                            {'name':"{:%}".format(0) if budget==0 else "{:%}".format(round((invoices_line[2]/1000)/(budget/1000)))},
                            # {'name':"{:.2%}".format(0) if budget==0 else "{:.2%}".format(((invoices_line[2]/1000)-(budget/1000))/(budget/1000))},
                            {'name':"{:%}".format(0) if budget==0 else "{:%}".format(round(((invoices_line[2]/1000)/(((budget/1000)/bussines_days.bussines_days)*self._billed_days(options,line_id))-1)))},
                            {'name':"{:%}".format(round(desv_price_per_kg)) },
