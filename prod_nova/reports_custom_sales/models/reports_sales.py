            ...
            for invoice in invoices:
                ...
                lines.append({
                        ...
                        'columns':[
                            ...
                            {'name':0 if self._billed_days(options,line_id)==0 or budget==False else "{:,.2f}".format((((invoices_line[2]/1000)/(self._billed_days(options,line_id)))*bussines_days.bussines_days)/1000)},
