...
class PurchaseOrder(models.Model):
    ...
    petitioner = fields.Many2one('res.users', 'Petitioner', related='requisition_id.user_id', readonly=True)
    petition_date = fields.Datetime('Petition Date',related='requisition_id.create_date',readonly=True)
    validator = fields.Many2one(string='Authorized', related='requisition_id.validator',readonly=True)
...
class PurchaseRequisition(models.Model):
    ...
    validator = fields.Many2one('res.users', 'Approver',readonly=True)
