            ...
            for c in conceptos:
                ...
                lines.append({
                        ...
                        'columns':[
                                ...
                                {'name':"{:.0%}".format(abs((account_analytic_line[0]['cantidad']/1000)/(account_analytic_line_total[0]['total']/1000))) if account_analytic_line_total and account_analytic_line else "{:.0%}".format(0)},
