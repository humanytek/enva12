class amChartsComponent {
    ...
    makeScorecardBasic() {
        ...
        if (recentValue === null) recentValue = 0;
        ...
        `
            <div class="flex-column flex-2" style="min-width: 0;">
                ...
                <div class="flex-row">
                    <div class="scorecard-value">`+ currencyCode +" "+ recentValue.toLocaleString() +`</div>
                    <small class="scorecard-particle">`+ particle +`</small>
                </div>
            </div>
            <div class="scorecard-img-container" style="">
                <img src="`+ self.imageUrl +`" alt="" class="scorecard-img">
            </div>
            `
            );
    ...
    makeScorecardTrend() {
        ...
        if ((self.data).length >= 2) {
            ...
            if (growthNum > 0) {
                elmGrowthNum = ` <div class="scorecard-status label label-success" title=" Increased from `+ previousValue +`">
                                    <span class="material-icons">arrow_drop_up</span>
                                    `+ growthNum +`% </div> `
            }else if(growthNum < 0){
                elmGrowthNum = ` <div class="scorecard-status label label-danger" title=" Decreased from `+ previousValue +`">
    ...
    makeScorecardProgress() {
        ...
        if (self.metric.length >= 2) {
            ...
            if (recentTarget > 0) {
                ...
                elmTarget = `
                    <div class="flex-row">
                        <div class="scorecard-target">From Target `+ currencyCode +" "+ recentTarget.toLocaleString() +`</div>
                        <small class="scorecard-particle">`+ particle +`</small>
                    </div>
                `;
            }
